...
# open document
f = open("neg test set.txt", "r", encoding="utf-8")
...
#print("Overall Positive accuracy = {}% via {} docs".format(pos_correct/doc_counter*100, doc_counter))
print("Overall Negative accuracy = {}% via {} docs".format(neg_correct/doc_counter*100, doc_counter))
